...
-(NSCalendar  *(^)(unsigned long long  firstWeekday))set_firstWeekday{
    __weak typeof(self) weakSelf = self;
    return ^(unsigned long long  firstWeekday){
        weakSelf.firstWeekday = firstWeekday;
        return weakSelf;
    };
}
...
-(NSCalendar  *(^)(unsigned long long  minimumDaysInFirstWeek))set_minimumDaysInFirstWeek{
    __weak typeof(self) weakSelf = self;
    return ^(unsigned long long  minimumDaysInFirstWeek){
        weakSelf.minimumDaysInFirstWeek = minimumDaysInFirstWeek;
        return weakSelf;
    };
}
