...
-(NSUndoManager  *(^)(BOOL  groupsByEvent))set_groupsByEvent{
    __weak typeof(self) weakSelf = self;
    return ^(BOOL  groupsByEvent){
        weakSelf.groupsByEvent = groupsByEvent;
        return weakSelf;
    };
}
...
-(NSUndoManager  *(^)(unsigned long long  levelsOfUndo))set_levelsOfUndo{
    __weak typeof(self) weakSelf = self;
    return ^(unsigned long long  levelsOfUndo){
        weakSelf.levelsOfUndo = levelsOfUndo;
        return weakSelf;
    };
}
...
-(NSUndoManager  *(^)(NSArray *  runLoopModes))set_runLoopModes{
    __weak typeof(self) weakSelf = self;
    return ^(NSArray *  runLoopModes){
        weakSelf.runLoopModes = runLoopModes;
        return weakSelf;
    };
}
