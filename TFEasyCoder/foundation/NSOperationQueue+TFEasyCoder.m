...
-(NSOperationQueue  *(^)(long long  maxConcurrentOperationCount))set_maxConcurrentOperationCount{
    __weak typeof(self) weakSelf = self;
    return ^(long long  maxConcurrentOperationCount){
        weakSelf.maxConcurrentOperationCount = maxConcurrentOperationCount;
        return weakSelf;
    };
}
...
-(NSOperationQueue  *(^)(dispatch_queue_t   underlyingQueue))set_underlyingQueue{
    ...
    return ^(dispatch_queue_t   underlyingQueue){
        weakSelf.underlyingQueue = underlyingQueue;
        return weakSelf;
    };
}
