...
-(NSScanner  *(^)(unsigned long long  scanLocation))set_scanLocation{
    __weak typeof(self) weakSelf = self;
    return ^(unsigned long long  scanLocation){
        weakSelf.scanLocation = scanLocation;
        return weakSelf;
    };
}
...
-(NSScanner  *(^)(NSCharacterSet *  charactersToBeSkipped))set_charactersToBeSkipped{
    ...
    return ^(NSCharacterSet *  charactersToBeSkipped){
        weakSelf.charactersToBeSkipped = charactersToBeSkipped;
        return weakSelf;
    };
}
...
-(NSScanner  *(^)(BOOL  caseSensitive))set_caseSensitive{
    ...
    return ^(BOOL  caseSensitive){
        weakSelf.caseSensitive = caseSensitive;
        return weakSelf;
    };
}
