...
typedef void(^NSFormatterEasyCoderBlock) (NSFormatter * ins);

@interface NSFormatter (TFEasyCoder)

+( NSFormatter *)easyCoder:(NSFormatterEasyCoderBlock)block;
-(NSFormatter *)easyCoder:(NSFormatterEasyCoderBlock)block;
...
-(NSFormatter *(^)(id value,NSString *key))set_ValueKey;
