...
typedef void(^NSMutableIndexSetEasyCoderBlock) (NSMutableIndexSet * ins);

@interface NSMutableIndexSet (TFEasyCoder)

+( NSMutableIndexSet *)easyCoder:(NSMutableIndexSetEasyCoderBlock)block;
-(NSMutableIndexSet *)easyCoder:(NSMutableIndexSetEasyCoderBlock)block;
...
-(NSMutableIndexSet *(^)(id value,NSString *key))set_ValueKey;
