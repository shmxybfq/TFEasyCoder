...
-(NSKeyedArchiver  *(^)(id<NSKeyedArchiverDelegate>    delegate))set_delegate{
    __weak typeof(self) weakSelf = self;
    return ^(id<NSKeyedArchiverDelegate>    delegate){
...
-(NSKeyedArchiver  *(^)(unsigned long long  outputFormat))set_outputFormat{
    __weak typeof(self) weakSelf = self;
    return ^(unsigned long long  outputFormat){
        weakSelf.outputFormat = outputFormat;
        return weakSelf;
    };
}
...
-(NSKeyedArchiver  *(^)(BOOL  requiresSecureCoding))set_requiresSecureCoding{
    ...
    return ^(BOOL  requiresSecureCoding){
        weakSelf.requiresSecureCoding = requiresSecureCoding;
        return weakSelf;
    };
}
