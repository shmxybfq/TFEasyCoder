...
+( NSEnergyFormatter *)easyCoder:(NSEnergyFormatterEasyCoderBlock)block{
    return [NSObject tf_execute:[self class] back:^(id ins) {
        if (block) {
            block(( NSEnergyFormatter *)ins);
        }
    }];
}
...
-(NSEnergyFormatter  *(^)(NSNumberFormatter *  numberFormatter))set_numberFormatter{
    ...
    return ^(NSNumberFormatter *  numberFormatter){
        weakSelf.numberFormatter = numberFormatter;
        return weakSelf;
    };
}
...
-(NSEnergyFormatter  *(^)(long long  unitStyle))set_unitStyle{
    __weak typeof(self) weakSelf = self;
    return ^(long long  unitStyle){
        weakSelf.unitStyle = unitStyle;
        return weakSelf;
    };
}
...
-(NSEnergyFormatter  *(^)(BOOL  forFoodEnergyUse))set_forFoodEnergyUse{
    ...
    return ^(BOOL  forFoodEnergyUse){
        weakSelf.forFoodEnergyUse = forFoodEnergyUse;
        return weakSelf;
    };
}
...
-(NSEnergyFormatter *(^)(id value,NSString *key))set_ValueKey{
    __weak typeof(self) weakSelf = self;
