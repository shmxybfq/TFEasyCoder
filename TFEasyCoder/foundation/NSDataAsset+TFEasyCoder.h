...
typedef void(^NSDataAssetEasyCoderBlock) (NSDataAsset * ins);

@interface NSDataAsset (TFEasyCoder)

+( NSDataAsset *)easyCoder:(NSDataAssetEasyCoderBlock)block;
-(NSDataAsset *)easyCoder:(NSDataAssetEasyCoderBlock)block;
...
-(NSDataAsset *(^)(id value,NSString *key))set_ValueKey;
