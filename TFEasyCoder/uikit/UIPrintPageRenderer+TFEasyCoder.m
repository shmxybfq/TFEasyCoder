...
-(UIPrintPageRenderer  *(^)(double  headerHeight))set_headerHeight{
    __weak typeof(self) weakSelf = self;
    return ^(double  headerHeight){
        weakSelf.headerHeight = headerHeight;
        return weakSelf;
    };
}
...
-(UIPrintPageRenderer  *(^)(double  footerHeight))set_footerHeight{
    __weak typeof(self) weakSelf = self;
    return ^(double  footerHeight){
        weakSelf.footerHeight = footerHeight;
        return weakSelf;
    };
}
...
-(UIPrintPageRenderer  *(^)(NSArray *  printFormatters))set_printFormatters{
    __weak typeof(self) weakSelf = self;
    return ^(NSArray *  printFormatters){
        weakSelf.printFormatters = printFormatters;
        return weakSelf;
    };
}
