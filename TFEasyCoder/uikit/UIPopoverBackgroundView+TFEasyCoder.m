...
+( UIPopoverBackgroundView *)easyCoder:(UIPopoverBackgroundViewEasyCoderBlock)block{
    return [NSObject tf_execute:[self class] back:^(id ins) {
        if (block) {
            block(( UIPopoverBackgroundView *)ins);
        }
    }];
}
...
-(UIPopoverBackgroundView  *(^)(double  arrowOffset))set_arrowOffset{
    __weak typeof(self) weakSelf = self;
    return ^(double  arrowOffset){
        weakSelf.arrowOffset = arrowOffset;
        return weakSelf;
    };
}
...
-(UIPopoverBackgroundView  *(^)(unsigned long long  arrowDirection))set_arrowDirection{
    __weak typeof(self) weakSelf = self;
    return ^(unsigned long long  arrowDirection){
        weakSelf.arrowDirection = arrowDirection;
        return weakSelf;
    };
}
