...
-(UIPrintInfo  *(^)(long long  outputType))set_outputType{
    __weak typeof(self) weakSelf = self;
    return ^(long long  outputType){
        weakSelf.outputType = outputType;
        return weakSelf;
    };
}
...
-(UIPrintInfo  *(^)(long long  orientation))set_orientation{
    __weak typeof(self) weakSelf = self;
    return ^(long long  orientation){
        weakSelf.orientation = orientation;
        return weakSelf;
    };
}
...
-(UIPrintInfo  *(^)(long long  duplex))set_duplex{
    __weak typeof(self) weakSelf = self;
    return ^(long long  duplex){
        weakSelf.duplex = duplex;
        return weakSelf;
    };
}
