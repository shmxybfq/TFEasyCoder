...
-(UIProgressView  *(^)(long long  progressViewStyle))set_progressViewStyle{
    __weak typeof(self) weakSelf = self;
    return ^(long long  progressViewStyle){
        weakSelf.progressViewStyle = progressViewStyle;
        return weakSelf;
    };
}
...
-(UIProgressView  *(^)(UIColor *  progressTintColor))set_progressTintColor{
    ...
    return ^(UIColor *  progressTintColor){
        weakSelf.progressTintColor = progressTintColor;
        return weakSelf;
    };
}
...
-(UIProgressView  *(^)(UIColor *  trackTintColor))set_trackTintColor{
    ...
    return ^(UIColor *  trackTintColor){
        weakSelf.trackTintColor = trackTintColor;
        return weakSelf;
    };
}
...
-(UIProgressView  *(^)(UIImage *  progressImage))set_progressImage{
    ...
    return ^(UIImage *  progressImage){
        weakSelf.progressImage = progressImage;
        return weakSelf;
    };
}
...
-(UIProgressView  *(^)(UIImage *  trackImage))set_trackImage{
    ...
    return ^(UIImage *  trackImage){
        weakSelf.trackImage = trackImage;
        return weakSelf;
    };
}
...
-(UIProgressView  *(^)(NSProgress *  observedProgress))set_observedProgress{
    ...
    return ^(NSProgress *  observedProgress){
        weakSelf.observedProgress = observedProgress;
        return weakSelf;
    };
}
