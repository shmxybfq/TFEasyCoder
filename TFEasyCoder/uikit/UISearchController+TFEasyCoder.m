...
-(UISearchController  *(^)(id<UISearchControllerDelegate>    delegate))set_delegate{
    __weak typeof(self) weakSelf = self;
    return ^(id<UISearchControllerDelegate>    delegate){
...
-(UISearchController  *(^)(BOOL  dimsBackgroundDuringPresentation))set_dimsBackgroundDuringPresentation{
    ...
    return ^(BOOL  dimsBackgroundDuringPresentation){
        weakSelf.dimsBackgroundDuringPresentation = dimsBackgroundDuringPresentation;
        return weakSelf;
    };
}
...
-(UISearchController  *(^)(BOOL  obscuresBackgroundDuringPresentation))set_obscuresBackgroundDuringPresentation{
    ...
    return ^(BOOL  obscuresBackgroundDuringPresentation){
        weakSelf.obscuresBackgroundDuringPresentation = obscuresBackgroundDuringPresentation;
        return weakSelf;
    };
}
...
-(UISearchController  *(^)(BOOL  hidesNavigationBarDuringPresentation))set_hidesNavigationBarDuringPresentation{
    ...
    return ^(BOOL  hidesNavigationBarDuringPresentation){
        weakSelf.hidesNavigationBarDuringPresentation = hidesNavigationBarDuringPresentation;
        return weakSelf;
    };
}
